    ...
    <table class="tb2" >
                ...
                <tr>
                    <th>
                        <center>
       <br><br>
        <p class="ab1">Sign Up Now</p><br>
        <p class="ab4">Please fill out this to register</p>
        <br>
        <form action="newuserregister" method="post">
            <div class="form-group">
                <label for="firstName"></label>
                <input type="text" name="username" id="firstName" required placeholder="Username" required class="usn">
            </div>
        </center>
        ...
        <center>
            <div class="form-group">
                ...
                <input type="email" class="usn" required minlength="6" placeholder="Email" required name="email" id="email"
        ...
        <center>
            <div class="form-group">
                ...
                <input type="password" class="pw" required placeholder=" Password" required name="password"
...
<span class="ab4">Already have an account <a class="ab3" href="index">Login here</a></span> <br><br>
<br>
            <input type="submit" value="Register" class="butlog"><br><br><br>
            </center>
        </th>
    </tr>
</table>
